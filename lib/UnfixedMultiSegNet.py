...
import cv2
from utils.MultiBatchDatasetReader import MultiBatchDatasetReader
...
class UnfixedMultiSegNet:
    ...
    def train(self, num_iterations, theta, is_trainable, dataset_directory,
        ...
        bdr = MultiBatchDatasetReader(dataset_directory, 480, 320, current_step, 
                                      batch_size)
        ...
        for i in range(current_step, num_iterations):
            ...
            # One training step
            images, ground_truths, theta = bdr.next_training_batch()
            ...
            if i % 100 == 0:
                images, ground_truths, theta = bdr.next_val_batch()
