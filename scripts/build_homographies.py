...
class HomographyComputer:
    ...
    def hamming_homography(self, A_path, B_path):
        ...
        img1_matches = []
        img2_matches = []
        length_of_matches_to_consider = min(len(matches), 10)
        for match in matches[:length_of_matches_to_consider]:
    ...
    def apply_homography(self, A_path, out_path):
...
for i in range(homography1_length):
	...
	hc.hamming_homography(view0_image_path, view1_image_path)
	homography1_image_path = homography1_images_path + "pic" + str(i) + ".png"
	hc.apply_homography(view0_image_path, homography1_image_path)
	...
	homography1_ground_truth_path = homography1_ground_truths_path + \
									"seg" + str(i) + ".png"
	hc.apply_homography(view0_ground_truth_path, homography1_ground_truth_path)